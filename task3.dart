import 'package:firstpro/screen/task2.dart';
import 'package:flutter/material.dart';

class taskkk extends StatefulWidget {
  const taskkk({super.key});

  @override
  State<taskkk> createState() => _taskkkState();
}

class _taskkkState extends State<taskkk> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            onPressed: (){
              Navigator.push(
                  context,
                  MaterialPageRoute(builder: (content)=>taskk()));
            }
        ),
